...
class _AdminLoginScreenState extends State<_AdminLoginScreen> {
        ...
        children: [
          ...
          TextField(
            ...
            decoration: InputDecoration(
              ...
              prefixIcon:
                  const Icon(Icons.phone_outlined, color: _kNavy, size: 20),
              filled: true,
          ...
          SizedBox(
            ...
            child: ElevatedButton(
              style: ElevatedButton.styleFrom(
                backgroundColor:
                    _phoneEntered ? _kNavy : Colors.grey.shade300,
              ...
              onPressed:
                  _phoneEntered && !_isLoading ? _goToPinEntry : null,
              child: _isLoading
                  ? const SizedBox(
                      width: 22,
                      height: 22,
  ...
  Future<void> _goToPinEntry() async {
    setState(() {
      _isLoading = true;
      _error = '';
    });
    ...
    if (admin == null) {
      setState(() {
        _error = 'Hakuna akaunti iliyosajiliwa';
        _isLoading = false;
      });
      return;
    }

    // Firebase sign in background — haitazuia PIN entry
    try {
      ...
      // Firebase ikifail — Hive bado inafanya kazi
      ...
      child: Column(
        ...
        children: [
          ...
          TextField(
            ...
            onChanged: (v) =>
                setState(() => _usernameEntered = v.trim().length >= 3),
            decoration: InputDecoration(
          ...
          SizedBox(
            ...
            child: ElevatedButton(
              style: ElevatedButton.styleFrom(
                backgroundColor: _usernameEntered
